      ...
      <fields>
        ...
        <add name='Reviewers' type='int' min='0' max='500' />
            ...
            using (var outer = new ConfigurationContainer().CreateScope(xml)) {
                using (var inner = new TestContainer(new BogusModule(), new ElasticsearchModule()).CreateScope(outer, new ConsoleLogger(LogLevel.Debug))) {
    ...
    <add name='contact'>
      <fields>
        ...
        <add name='reviewers' type='int' />
            ...
            using (var outer = new ConfigurationContainer().CreateScope(xml)) {
                using (var inner = new TestContainer(new ElasticsearchModule()).CreateScope(outer, new ConsoleLogger(LogLevel.Debug))) {
