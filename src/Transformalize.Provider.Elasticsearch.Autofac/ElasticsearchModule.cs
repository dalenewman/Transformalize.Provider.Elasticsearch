        ...
        protected override void Load(ContainerBuilder builder) {
            ...
            foreach (var connection in process.Connections.Where(c => c.Provider == "elasticsearch")) {
                ...
                builder.Register(ctx => {
                    ...
                    if (process.Mode != "init" && connection.RequestTimeout >= 0) {
                ...
                foreach (var entity in process.Entities.Where(e => e.Connection == connection.Name)) {
            ...
            // Entity Input
            foreach (var entity in process.Entities.Where(e => process.Connections.First(c => c.Name == e.Connection).Provider == "elasticsearch")) {
            ...
            // Entity Output
            if (process.Output().Provider == "elasticsearch") {
                ...
                foreach (var entity in process.Entities) {
                    ...
                    builder.Register<IOutputController>(ctx => {
                        ...
                        switch (output.Connection.Provider) {
                            case "elasticsearch":
                                var initializer = process.Mode == "init" ? (IAction)new ElasticEntityInitializer(output, ctx.ResolveNamed<IElasticLowLevelClient>(output.Connection.Key)) : new NullInitializer();
